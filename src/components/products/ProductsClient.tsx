...
const FALLBACK_PRODUCTS = [
  { id: '1', name: '小叶紫檀手串', name_en: 'Sacred Rosewood Mala', slug: 'xiaoye-zitan', price: 899, original_price: 1299, stock: 50, images: ['https://images.unsplash.com/photo-1590534247854-e97d5e3ed38e?w=400'], description: '精选印度小叶紫檀，纹理细腻，油密度高', status: 'active', category_id: 'practice-tools', material: '小叶紫檀', use_case: '佩戴', subcategory: '念珠手串', tags: ['原材正宗', '手工精作'] },
  { id: '2', name: '铜镀金释迦牟尼佛像', name_en: 'The Enlightened One: Shakyamuni Buddha', slug: 'sakyamuni-buddha', price: 3680, original_price: 4999, stock: 10, images: ['https://images.unsplash.com/photo-1599707367072-cd6cf66a80a2?w=400'], description: '精铜铸造，镀金工艺，庄严殊胜', status: 'active', category_id: 'offerings', material: '金铜造像', use_case: '供奉', subcategory: '佛像造像', tags: ['名家手工', '权威鉴定'] },
  { id: '3', name: '天然沉香线香', name_en: 'Premium Agarwood Incense', slug: 'chenxiang-incense', price: 168, stock: 100, images: ['https://images.unsplash.com/photo-1591129841117-3adfd313e34f?w=400'], description: '天然越南芽庄沉香，清新淡雅', status: 'active', category_id: 'offerings', material: '越南芽庄沉香', use_case: '居家', subcategory: '香炉供具', tags: ['天然纯品', '古法炮制'] },
  { id: '4', name: '莲花纹铜香炉', name_en: 'Lotus Bronze Censer', slug: 'lotus-censer', price: 458, stock: 25, images: ['https://images.unsplash.com/photo-1602523961358-9dfd4ea5a6d0?w=400'], description: '精铜铸造，莲花纹理，仿古工艺', status: 'active', category_id: 'offerings', material: '精铜', use_case: '居家', subcategory: '香炉供具', tags: ['乾隆款识', '收藏价值'] },
  { id: '5', name: '心经书法卷轴', name_en: 'Heart Sutra Calligraphy Scroll', slug: 'xingjing-scroll', price: 1280, original_price: 1680, stock: 30, images: ['https://images.unsplash.com/photo-1516962215378-7fa2e137ae91?w=400'], description: '名家手书，宣纸影印，锦绫装裱', status: 'active', category_id: 'dharma-audio', material: '泾县熟宣', use_case: '修行', subcategory: '经书法物', tags: ['名家手书', '锦绫装裱'] },
  { id: '6', name: '如法棋', name_en: 'Sacred Rufa Oracle Chess', slug: 'rufa-chess', price: 2520, original_price: 3200, stock: 99, images: ['https://images.unsplash.com/photo-1606103935946-6b5a3f1a7d0b?w=400'], description: '承载千年佛学精神体系，密宗投骰游戏', status: 'active', category_id: 'practice-tools', material: '木石良金', use_case: '共修', subcategory: '修行辅助', tags: ['密宗传承', '佛友共修'] },
  { id: '7', name: '宋锦丝绒拜垫', name_en: 'Songjin Velvet Cushion', slug: 'songbo', price: 680, stock: 45, images: ['https://images.unsplash.com/photo-1545205597-3d9d02c29597?w=400'], description: '宋锦面料，丝绒内衬，柔软舒适', status: 'active', category_id: 'practice-tools', material: '天然黄麻', use_case: '修行', subcategory: '修行辅助', tags: ['天然材料', '打坐必备'] },
  { id: '8', name: '转经轮', name_en: 'Prayer Wheel', slug: 'zhuanjinglun', price: 1280, stock: 20, images: ['https://images.unsplash.com/photo-1609766857041-ed402ea8069a?w=400'], description: '黄铜转经轮，手工錾刻，经文环绕', status: 'active', category_id: 'dharma-audio', material: '纯铜', use_case: '供奉', subcategory: '法音载体', tags: ['光伏感应', '藏传法物'] },
]
